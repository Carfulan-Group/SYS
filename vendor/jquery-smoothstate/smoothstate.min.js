...
} ( function ( t, e, n, o )
{
	...
	if ( ! t.fn.smoothState )
	{
		var r = t ( "html, body" ), a = e.console, i = {
			...
			{
				var n = t.match ( /^([^:\/?#]+:)?(?:\/\/([^\/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/ );
				return "string" == typeof n[ 1 ] && n[ 1 ].length > 0 && n[ 1 ].toLowerCase () !== e.location.protocol ? ! 0 : "string" == typeof n[ 2 ] && n[ 2 ].length > 0 && n[ 2 ].replace ( new RegExp ( ":(" + { "http:" : 80, "https:" : 443 }[ e.location.protocol ] + ")?$" ), "" ) !== e.location.host ? ! 0 : ! 1
			...
			{
				n     = n || e.location.href;
				var o = t.indexOf ( "#" ) > - 1 ? ! 0 : ! 1, r = s.stripHash ( t ) === s.stripHash ( n ) ? ! 0 : ! 1;
				return o && r
		...
		}, l  = function ( n )
		{
			if ( null !== n.state )
			{
				var o = e.location.href, r = t ( "#" + n.state.id ), a = r.data ( "smoothState" ), i = a.href !== o && ! s.isHash ( o, a.href ), l = event.state !== a.cache[ a.href ].state;
		...
		}, u  = function ( i, l )
		{
			...
			{
				l.anchors && (t.on ( "click", l.anchors, b ), l.prefetch && t.find ( l.anchors ).not ( l.prefetchBlacklist ).on ( l.prefetchOn, null, E )), l.forms && t.on ( "submit", l.forms, C )
			}, x  = function ()
			{
				var t = u.prop ( "class" );
